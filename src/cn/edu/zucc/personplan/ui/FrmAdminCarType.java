...
public class FrmAdminCarType extends JFrame implements ActionListener {
...
//                carTypeTblDataDo.reloadTable(true);
            ...
            try {
                frmAddCarType = new FrmAddCarType();
            } catch (BaseException ex) {
                ex.printStackTrace();
            } catch (SQLException ex) {
                ex.printStackTrace();
...
//            frmUserOrderStatus.setVisible(true);
    ...
    public FrmAdminCarType() throws BaseException, SQLException {
