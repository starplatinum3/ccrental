...
public class FrmCarAssign extends JFrame implements ActionListener {
...
//    FrmAddCar  frmAddCar =new FrmAddCar();
    ...
    private JButton btnCarAssign = new JButton("分配网点");
...
//            }
        ...
        }else if (e.getSource() == this.btnCarAssign) {
         if(tddNetInfo.current==null){
...
//    String[] titles = new String[]{"车", "报废信息", "车型","报废信息"};
    String[] titles = new String[]{"车", "网点", "车型","报废信息"};

    public FrmCarAssign() throws BaseException, SQLException {
